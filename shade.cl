...
__kernel void render(__global float4* photonMap, int photonCount, __global float* dosageMap,// __global unsigned int* triangles,
    __global float* vertices)
{
    ...
    //TODO: triangles are not fat
    uint v1ID = threadID * 3;
    uint v2ID = (threadID + 1) * 3;
    uint v3ID = (threadID + 2) * 3;
